...
boolean comparar(int senha, int senhaTentada){
  if (senha != senhaTentada){
...
{
  par=String(myString).toInt(); //exemplo de uso da string recebida
  if(par == 30){
    abrir(true);
  }
  if (par == 10){
  ...
  if (par == 20){
    validacao = comparar (senha,batidas);
    abrir(validacao);
    batidas=0;
  }
  if (par == 1){
